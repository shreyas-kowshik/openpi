...
# =============================================================================
# RoboCasa: Pi-0.5 single-task fine-tuning
# LoRA on VLM, full fine-tune on action head
#
# Usage:
#   sbatch slurm/robocasa/slurm_robocasa_single_task.sh              # default 5 demos
#   NUM_DEMOS=10 sbatch slurm/robocasa/slurm_robocasa_single_task.sh # override demo count
# =============================================================================
