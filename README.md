...
##### Dump filtered data for all libero10 tasks
```
python scripts/dump_filtered_data.py --num_episodes 1 --output_dir data_dumps --filter_prompt "put both the alphabet soup and the tomato sauce in the basket"

python scripts/dump_filtered_data.py --num_episodes 1 --output_dir data_dumps --filter_prompt "put both the cream cheese box and the butter in the basket"

python scripts/dump_filtered_data.py --num_episodes 1 --output_dir data_dumps --filter_prompt "turn on the stove and put the moka pot on it"

python scripts/dump_filtered_data.py --num_episodes 1 --output_dir data_dumps --filter_prompt "put the black bowl in the bottom drawer of the cabinet and close it"

python scripts/dump_filtered_data.py --num_episodes 1 --output_dir data_dumps --filter_prompt "put the white mug on the left plate and put the yellow and white mug on the right plate"

python scripts/dump_filtered_data.py --num_episodes 1 --output_dir data_dumps --filter_prompt "pick up the book and place it in the back compartment of the caddy"

python scripts/dump_filtered_data.py --num_episodes 1 --output_dir data_dumps --filter_prompt "put the white mug on the plate and put the chocolate pudding to the right of the plate"

python scripts/dump_filtered_data.py --num_episodes 1 --output_dir data_dumps --filter_prompt "put both the alphabet soup and the cream cheese box in the basket"
